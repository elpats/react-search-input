  ...
  _createClass(Search, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          value = _props.value,
          fuzzy = _props.fuzzy,
          unidecode = _props.unidecode,
          inputClassName = _props.inputClassName,
          inputProps = _objectWithoutProperties(_props, ['className', 'onChange', 'caseSensitive', 'sortResults', 'throttle', 'filterKeys', 'value', 'fuzzy', 'unidecode', 'inputClassName']); // eslint-disable-line no-unused-vars
...
Search.propTypes = {
  ...
  unidecode: _propTypes2.default.bool,
